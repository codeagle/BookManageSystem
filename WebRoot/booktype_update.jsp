...
<link href="CSS/style.css" rel="stylesheet">   
  ...
  <tr>
   ...
   <form name="form1" method="post" action="BookTpeUpdateServlet">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="50" align="center">  图书类型名称：
        <input name="typeid" type="hidden" size="50" value="<%=booktype.getBtypeid() %>">
       <input name="typename" type="text" value="<%=booktype.getBtypename() %>"></td>
      </tr>
      <tr>
