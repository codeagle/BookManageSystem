  ...
  <td style="padding:5px;"><%=bookinfo.getBookid() %></td>
   <td style="padding:5px;"><%=bookinfo.getBookname() %></td>
    ...
    <td style="padding:5px;"><%=bookinfo.getTotal()%></td>
     <td align="center"><a href="BookInfoFindByIdServlet?bookid=<%=bookinfo.getBookid() %>&btypename=<%=bookinfo.getBtypename()%>&pub=<%=bookinfo.getPubname() %>&casename=<%=bookinfo.getCname() %>" >修改</a></td>
