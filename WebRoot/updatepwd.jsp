      ...
      <tr>
        ...
        <td><table width="100%" height="131"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <form name="form1" method="post" action="UpdatePwdServlet">
                <table width="100%" height="114"  border="0" cellpadding="0" cellspacing="0">
                  <tr ><td>
                   <input name="userid"  type="hidden"  value="<%=session.getAttribute("userid") %>"/><br>
                   修改密码：<input name="pwd" type="password"/><br>
                     <td>
                    </tr>
                  <tr>
